...
const BaseColors = {
  ...
  text: Color('#94A7B0'),
  selectionBackground: Color('#80CBC440'),
  selectionForeground: Color('#546e7a'),
  buttons: Color('#F3F4F5'),
  secondBackground: Color('#FFFFFF'),
  disabled: Color('#D2D4D5'),
  contrast: Color('#EEEEEE'),
  active: Color('#E7E7E8'),
  border: Color('#d3e1e8'),
  highlight: Color('#E7E7E8'),
  tree: Color('#80CBC440'),
  notifications: Color('#eae8e8'),
  accent: Color('#00BCD4'),
  excludedFilesColor: Color('#CCD7DA50'),
  green: Color('#91b859'),
  yellow: Color('#f6a434'),
  blue: Color('#6182b8'),
  red: Color('#e53935'),
...
const Theme: CustomTheme = {
  ...
  colors: {
    ...
    surfaceVariant: palette.backgroundSecondary40,
