...
export default class PresenceStore extends BaseStore {
  ...
  static getStatusColor(status: PresenceUpdateStatus) {
    ...
    switch (status) {
      case 'online':
        return theme.colors.palette.status_online_80;
      case 'idle':
        return theme.colors.palette.status_idle_80;
      case 'dnd':
        return theme.colors.palette.status_dnd_80;
      case 'offline':
      case 'invisible':
        return theme.colors.palette.status_offline_80;
    }
  }
